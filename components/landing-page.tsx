...
export default function LandingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "É um pagamento único de apenas 9,90€. Não existem taxas adicionais nem mensalidades.",
      color: "indigo",
    },
    {
      ...
      <div className="min-h-screen bg-white font-sans">
        ...
        <section className="px-6 py-6 text-center">
          <div className="max-w-md mx-auto">
            ...
            >
              🛒 Sim, quero garantir já o MÉTODO por 19,90€!
            </a>
          </div>
        </section>
                ...
                >
                  ...
                  {openFAQ === index && (
                    <div className="px-6 pb-6">
                      ...
                      {faq.question.includes("não gostar") && (
                        <p className={`text-${faq.color}-800 leading-relaxed mt-2`}>
                          Não há risco! Tens 7 dias de garantia: se não estiveres satisfeito, basta enviar um e-mail
                          para contato@escolinha.shop e devolvemos o valor.
                        </p>
                      )}
                    </div>
                  )}
